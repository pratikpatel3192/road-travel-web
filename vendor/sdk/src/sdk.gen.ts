 ...
 */
export const getTripSnapshotV1TripsTripIdSnapshotGet = <ThrowOnError extends boolean = false>(options: Options<GetTripSnapshotV1TripsTripIdSnapshotGetData, ThrowOnError>): RequestResult<GetTripSnapshotV1TripsTripIdSnapshotGetResponses, GetTripSnapshotV1TripsTripIdSnapshotGetErrors, ThrowOnError> => (options.client ?? client).get<GetTripSnapshotV1TripsTripIdSnapshotGetResponses, GetTripSnapshotV1TripsTripIdSnapshotGetErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const saveTripSnapshotV1TripsTripIdSnapshotPut = <ThrowOnError extends boolean = false>(options: Options<SaveTripSnapshotV1TripsTripIdSnapshotPutData, ThrowOnError>): RequestResult<SaveTripSnapshotV1TripsTripIdSnapshotPutResponses, SaveTripSnapshotV1TripsTripIdSnapshotPutErrors, ThrowOnError> => (options.client ?? client).put<SaveTripSnapshotV1TripsTripIdSnapshotPutResponses, SaveTripSnapshotV1TripsTripIdSnapshotPutErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/v1/trips/{trip_id}/snapshot',
    ...options,
    headers: {
 ...
 */
export const createItineraryBriefingV1BriefingsItineraryPost = <ThrowOnError extends boolean = false>(options: Options<CreateItineraryBriefingV1BriefingsItineraryPostData, ThrowOnError>): RequestResult<CreateItineraryBriefingV1BriefingsItineraryPostResponses, CreateItineraryBriefingV1BriefingsItineraryPostErrors, ThrowOnError> => (options.client ?? client).post<CreateItineraryBriefingV1BriefingsItineraryPostResponses, CreateItineraryBriefingV1BriefingsItineraryPostErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const recordTouchV1AttributionTouchPost = <ThrowOnError extends boolean = false>(options: Options<RecordTouchV1AttributionTouchPostData, ThrowOnError>): RequestResult<RecordTouchV1AttributionTouchPostResponses, RecordTouchV1AttributionTouchPostErrors, ThrowOnError> => (options.client ?? client).post<RecordTouchV1AttributionTouchPostResponses, RecordTouchV1AttributionTouchPostErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * `dry_run` defaults to **true**: the default behaviour of an endpoint that sends marketing to real users should be to send nothing. Pass `false` deliberately.
 */
export const runSequenceEmailsV1OpsLifecycleRunSequencePost = <ThrowOnError extends boolean = false>(options: Options<RunSequenceEmailsV1OpsLifecycleRunSequencePostData, ThrowOnError>): RequestResult<RunSequenceEmailsV1OpsLifecycleRunSequencePostResponses, RunSequenceEmailsV1OpsLifecycleRunSequencePostErrors, ThrowOnError> => (options.client ?? client).post<RunSequenceEmailsV1OpsLifecycleRunSequencePostResponses, RunSequenceEmailsV1OpsLifecycleRunSequencePostErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],

...
export const LUCIDE: Record<string, string> = {
  ...
  // Added with the long-range outlook. The Phase 1c disclaimer already asked for `calendar`
  // and got nothing: an unknown name resolves to '' and renders silently, so the icon was
  // simply invisible rather than broken in any way a reader would report.
